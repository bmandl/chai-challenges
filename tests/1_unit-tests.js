...
// -----------------------------------------------------------------------------
  ...
  suite('Comparisons', function() {
    ...
    test('#approximately', function() {
      assert.approximately(weirdNumbers(0.5) , 1, 0.5,"number should be between 0.5 and 1.5" );
      assert.approximately(weirdNumbers(0.2) , 1, 0.8,"number should be between 0.2 and 1.8" );
    });
  });
